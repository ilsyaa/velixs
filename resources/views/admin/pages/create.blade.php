    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Add New Page</h2>
            ...
            <div class="content-body">
                <form class="submit-form" action="{{ route('pages.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                            ...
                            <div class="card">
                                <div class="card-body p-1">
                                    ...
                                    <select class="form-select" name="robots">
                                        <option {{ old('robots') == 'index' ? 'selected' : '' }} value="index">index, follow</option>
                                        <option {{ old('robots') == 'noindex' ? 'selected' : '' }} value="noindex">noindex, nofollow</option>
                                    </select>
                                </div>
                            </div>
                        </div>
