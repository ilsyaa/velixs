...
@section('title', 'All Trash Products')
...
@section('js')
    ...
    <script>
        datatables_luxion(
            '.datatables-basic',
            '{{ route('product.json', 'trash') }}',
            '{{ route('product.forcedelete') }}',
            [{
                    data: 'responsive_id'
                },
                {
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Manage Trash Product</h2>
